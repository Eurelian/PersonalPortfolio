										...
										<Card className={classes.card}>
											<CardContent>
												...
												<ul style={{ listStyleType: "none", padding: 0 }}>
													...
													<li className={classes.listItem}>PostgreSQL</li>
													<li className={classes.listItem}>GitHUB</li>
													<li className={classes.listItem}>Heroku</li>
												</ul>
											</CardContent>
										</Card>
									</Grid>
									...
									>
										<Card className={classes.card}>
											<CardContent>
												...
												<ul style={{ listStyleType: "none", padding: 0 }}>
													<li className={classes.listItem}>Trello</li>
													<li className={classes.listItem}>Slack</li>
